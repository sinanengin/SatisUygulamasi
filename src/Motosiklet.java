public class Motosiklet extends Vasita{
    ...
    public Motosiklet(int ilanID, int userID, String baslik, String aciklama, int fiyat, String marka, String model, String vitesTipi, String renk, int uretimYili, int motorHacim, String motorTip)
    {
